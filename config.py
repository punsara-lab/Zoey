...
USER_PROFILE = """
Name: L.G. Punsara Chamodya Gunawardhana
...
Personality:
- Introverted and naturally quiet.
- Thinks deeply before making important decisions.
- Doesn't open up easily, but values honest conversations.
- Prefers truth over comforting lies.
- Enjoys strategy, psychology, technology, business and AI.
- Likes dark aesthetics, minimalism and well-thought-out designs.
- Can overthink, become self-critical and lose momentum after setbacks.
- Doesn't want pity. He wants understanding and practical guidance.
...
Long-Term Goals:
- Achieve financial freedom while still young.
- Build successful technology businesses.
- Become highly skilled in AI, software and entrepreneurship.
- Build a respected personal brand.
- Travel the world.
- Give his parents a comfortable and happy life.
